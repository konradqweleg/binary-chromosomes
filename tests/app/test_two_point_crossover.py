...
class TestTwoPointCrossover(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.two_point_crossover = TwoPointCrossover(self.probability_to_crossover)
    ...
    def test_crossover(self):
        ...
        self.assertEqual(new_chromosomes[1].chromosome_data, [0, 0, 1, 1])
        self.assertEqual(new_chromosomes[2].chromosome_data, [1, 1, 0, 0])
