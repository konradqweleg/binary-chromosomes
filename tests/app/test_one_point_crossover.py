...
class TestOnePointCrossover(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.crossover = OnePointCrossover(self.probability_to_crossover)
    ...
    def test_cross(self):
        ...
        self.assertEqual(len(new_chromosomes), self.expected_new_population_size)
        self.assertEqual(new_chromosomes[0].chromosome_data, [1, 1, 0, 1])
        self.assertEqual(new_chromosomes[1].chromosome_data, [0, 0, 1, 0])
