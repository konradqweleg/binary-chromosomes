...
class MainFrame:
    ...
    def _get_form_data(self):
        ...
        binary_chromosomes_configuration_data.roulette_wheel_selection_percentage_chromosomes_to_select = self.roulette_wheel_selection_percentage_chromosomes_to_select_entry.get()
